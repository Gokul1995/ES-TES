...
@Component({
  selector: 'app-patners-bank',
  templateUrl: './patners-bank.component.html',
  styleUrls: ['./patners-bank.component.scss']
})
export class PatnersBankComponent implements OnInit {
